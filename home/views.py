	...
	if request.method == "POST":
		...
		if status[1] == "Success":
			...
			if tag[0] == "N":
				...
				UserRelationActual.objects.create(childUsername=userRel.childUsername,sponserId=userRel.sponserId,parentUsername=userRel.parentUsername,parentId=userRel.parentId)
